                        ...
                        if villages_gdf is not None:
                            ...
                            if v_dist_col:
                                ...
                                if not local_villages.empty:
                                    ...
                                    # 2. DRAW RESOURCES (Vectorized & Sanitized)
